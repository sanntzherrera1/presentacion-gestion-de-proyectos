...
export const OBJECTS = [
  ...
  // ── Characters ──
  { key: 'basic_char',         label: 'Basic Char',         url: './assets/SproutLands-Sprites/Characters/BasicCharakterSpritesheet.png', cols: 4, rows: 4, frameW: 48, frameH: 48, category: 'characters' },
